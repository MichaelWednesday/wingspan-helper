<template>
  <div id="wrapper">
    ...
    <div id="app">
      ...
      <footer id="footer">
        Contribute on
        <a href="https://github.com/MichaelWednesday/wingspan-helper">GitHub</a> •
        Original version by
        <a href="https://github.com/greengiraffe/wingspan-helper">greengiraffe</a> •
...
.nav-item {
  ...
  &.scoresheet {
    ...
    &::after {
      // this is overlayed by the inactive automata tab
      // that has a rounded corner, it makes the rounded
      // edge of the tab visible
      content: "";
      position: absolute;
      width: $border-radius-default;
      height: $border-radius-default;
      bottom: 0;
      right: -$border-radius-default;
      background-color: $color-fg;
    }
  }
  ...
  &.automata {
    ...
    &::after {
      // creates a subtle shadow that does not conflict with
